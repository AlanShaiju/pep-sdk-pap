...
public class PapSdkAutoConfiguration {
    ...
    @Bean public PapTransactionService.Configuration papTransactionServiceConfig(
            PapEntityRegistry registry,
            ...
            Clock clock) {
        return new PapTransactionService.Configuration(registry, builder, client, txRepo, divRepo,
                papSdkSharedEntityManager, om, clock);
    }

    @Bean public PapTransactionService papTransactionService(PapTransactionService.Configuration config) {
        return new PapTransactionService(config);
    }
